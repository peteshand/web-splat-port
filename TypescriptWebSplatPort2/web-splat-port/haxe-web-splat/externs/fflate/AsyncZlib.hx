...
**/
@:jsRequire("fflate", "AsyncZlib") extern class AsyncZlib {
	/**
		Creates an asynchronous Zlib stream
	**/
	@:overload(function(?cb:AsyncFlateStreamHandler):AsyncZlib { })
	function new(opts:ZlibOptions, ?cb:AsyncFlateStreamHandler);
	/**
	...
	**/
	...
	static var prototype : AsyncZlib;
}