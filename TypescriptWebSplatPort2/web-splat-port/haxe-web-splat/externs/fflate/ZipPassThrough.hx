...
**/
@:jsRequire("fflate", "ZipPassThrough") extern class ZipPassThrough {
	/**
	...
	**/
	private function process(chunk:js.lib.Uint8Array, final_:Bool):Void;
	/**
	...
	**/
	...
	static var prototype : ZipPassThrough;
}