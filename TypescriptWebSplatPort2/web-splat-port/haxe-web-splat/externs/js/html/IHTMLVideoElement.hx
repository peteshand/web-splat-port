...
typedef IHTMLVideoElement = {
	...
	**/
	...
	var msZoom : Bool;
	@:optional
	dynamic function onMSVideoFormatChanged(ev:js.html.Event):Dynamic;
	@:optional
	dynamic function onMSVideoFrameStepCompleted(ev:js.html.Event):Dynamic;
	@:optional
	dynamic function onMSVideoOptimalLayoutChanged(ev:js.html.Event):Dynamic;
	/**
	...
	**/
	var width : Float;
	function getVideoPlaybackQuality():js.html.VideoPlaybackQuality;
	...
	**/
	final audioTracks : js.html.AudioTrackList;
	/**
	...
	**/
	final buffered : js.html.TimeRanges;
	/**
	...
	**/
	final error : Null<js.html.MediaError>;
	/**
		Gets or sets a flag to specify whether playback should restart after it completes.
	**/
	var loop : Bool;
	final mediaKeys : Null<js.html.eme.MediaKeys>;
	/**
	...
	**/
	...
	@:optional
	dynamic function onencrypted(ev:js.html.eme.MediaEncryptedEvent):Dynamic;
	@:optional
	dynamic function onmsneedkey(ev:js.html.Event):Dynamic;
	@:optional
	dynamic function onwaitingforkey(ev:js.html.Event):Dynamic;
	/**
	...
	**/
	final played : js.html.TimeRanges;
	/**
		Gets or sets the current playback position, in seconds.
	**/
	var preload : String;
	...
	**/
	final seekable : js.html.TimeRanges;
	/**
	...
	**/
	var src : String;
	var srcObject : Null<ts.AnyOf3<js.html.Blob, js.html.MediaStream, js.html.MediaSource>>;
	final textTracks : js.html.TextTrackList;
	final videoTracks : js.html.VideoTrackList;
	/**
	...
	**/
	function play():js.lib.Promise<ts.Undefined>;
	function setMediaKeys(mediaKeys:Null<js.html.eme.MediaKeys>):js.lib.Promise<ts.Undefined>;
