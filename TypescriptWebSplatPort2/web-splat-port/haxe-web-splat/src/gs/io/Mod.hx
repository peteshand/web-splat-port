...
import gs.pointcloud.Quantization;
import gs.io.PlyReader;
import gs.io.NpzReader;
import gs.io.NpzReader.ZipNpzArchive;
import gs.pointcloud.types.GenericGaussianPointCloud as BaseGenericGaussianPointCloud;
...
class GenericGaussianPointCloud implements BaseGenericGaussianPointCloud {
