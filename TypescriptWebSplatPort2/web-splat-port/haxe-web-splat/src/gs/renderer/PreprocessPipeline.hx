...
class PreprocessPipeline {
  ...
  public static function create(
    ...
    final wgslPath = compressed ? './gs/shaders/preprocess_compressed.wgsl' : './gs/shaders/preprocess.wgsl';
    return window.fetch(wgslPath)
      ...
      .then((src:String) -> {
        ...
        gs.renderer.Internal.logi('[preprocess::new]', 'sh_deg=' + shDeg + ', compressed=' + compressed);
        return self;
      });
  }
  ...
  public function run(
    ...
    gs.renderer.Internal.logi('[preprocess::run]', 'dispatch_x=' + wgsX + ', num_points=' + numPoints);
