...
import gs.pointcloud.Quantization.GaussianQuantization;

class Utils {

  public static inline function isArrayBufferView(?view:ArrayBufferView, ?q:gs.pointcloud.Quantization.GaussianQuantization):Bool {
    return view != null;
  }
  ...
  public static function packGaussianQuantizationToBytes(q:GaussianQuantization):js.lib.Uint8Array {
