...
export class CameraController {
    ...
    right_mouse_pressed;
    alt_pressed;
    user_inptut; // keep original typo for 1:1 API
...
function lookRotation(forward, up) {
    ...
    const m = mat3.fromValues(r[0], r[1], r[2], u[0], u[1], u[2], f[0], f[1], f[2]);
