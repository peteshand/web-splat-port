...
export class CameraController {
    ...
    resetToCamera(camera) {
        const cameraQuat = quat.fromValues(camera.rotationQuat[0], camera.rotationQuat[1], camera.rotationQuat[2], camera.rotationQuat[3]);
    ...
    updateCamera(camera, dt) {
        ...
        const rotMat = mat3.fromValues(right[0], up[0], -forward[0], right[1], up[1], -forward[1], right[2], up[2], -forward[2]);
